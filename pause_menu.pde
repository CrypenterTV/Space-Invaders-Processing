class PauseMenu extends Menu {
    ...
    void initButtons() {
        ...
        addButton(new Button(new PVector((width - int(1.5 * _menuWidth / 3)) / 2, height / 4 + 7 * _menuHeight / 9), int(1.5 * _menuWidth / 3), _menuHeight / 9, "Quitter", COLOR_TEXT_BUTTON, new ButtonAction() {
            void onClick(int mb) {
